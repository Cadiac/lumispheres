...
# By Gasman <http:-compiler-v20230802.jar//matt.west.co.tt/>
# from an original idea by Daeken: http://daeken.com/superpacking-js-demos


MAX_WIDTH = 16000 #4096
USE_PNGOUT = true
...
if js.length < MAX_WIDTH
	...
	html = "<canvas id=c><canvas id=d><img onload=with(d.getContext('2d'))for(p=e='';drawImage(this,p--,0),t=getImageData(0,0,1,1).data[0];)e+=String.fromCharCode(t);(1,eval)(e) src=#>"
else
	js = "\x00" + js
	width = MAX_WIDTH
	...
	html = "<canvas id=c><canvas id=d><img onload=for(w=d.width=#{width},a=d.getContext('2d'),a.drawImage(this,p=0,0),e='',d=a.getImageData(0,0,w,#{height}).data;t=d[p+=4];)e+=String.fromCharCode(t);(1,eval)(e) src=#>"
end
